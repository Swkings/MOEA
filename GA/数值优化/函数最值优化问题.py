...
class GA:
	...
	def fitness(self):
		...
		fitnessValue = [math.exp(item) for item in fitnessValueTemp]
...
if __name__ == '__main__':
	...
	GA = GA(objFunc=objF4, genoNum=paraNum4, valueSpan=span4, accuracy=6, cp=0.75, mp=0.2, populationSize=200, maxGeneration=100, isMin=isMin4)
	pop = GA.run()
